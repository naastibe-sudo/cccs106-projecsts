...
def main(page: ft.Page):
    ...
    program_dropdown = ft.Dropdown(
        ...
        options=[
            ...
            ft.dropdown.Option("BSCE", "Bachelor of Science in Computer Engineering"),
    ...
    # Output container - FIXED: Added initial text with black color
    output_container = ft.Container(
        content=ft.Text(
            "Fill out the form and click 'Generate Profile' to see your information.",
            color=ft.Colors.BLACK  # Explicitly set text color
        ),
    ...
    def generate_profile(e):
        try:
            ...
            # Generate profile - FIXED: Added explicit black color to all text
            profile_content = ft.Column([
                ft.Text("🎓 STUDENT PROFILE", size=20, weight=ft.FontWeight.BOLD, color=ft.Colors.INDIGO_700),
                ft.Divider(),
                ft.Text(f"👤 Full Name: {first_name.value} {last_name.value}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"🆔 Student ID: {student_id.value or 'Not provided'}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"🎂 Age: {age.value} years old", size=16, color=ft.Colors.BLACK),
                ft.Text(f"📅 Birth Year: {birth_year}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"📚 Program: {program_dropdown.value or 'Not selected'}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"📊 Year Level: {year_level.value or 'Not selected'}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"🎨 Favorite Color: {favorite_color.value or 'Not selected'}", size=16, color=ft.Colors.BLACK),
                ft.Text(f"🎯 Hobbies: {hobbies.value or 'Not provided'}", size=16, color=ft.Colors.BLACK),
                ft.Divider(),
                ft.Text(f"🎓 Expected Graduation: {graduation_year}", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
    ...
    page.add(
        ft.Column([
            title,
            ft.Divider(),
            ft.Text("Personal Information", size=18, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
            ft.Row([first_name, last_name], spacing=20),
            ft.Row([age, student_id], spacing=20),
            program_dropdown,
            ft.Text("Year Level:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
            year_level,
            favorite_color,
            hobbies,
            ft.Divider(),
            ...
            ft.Divider(),
            ft.Text("Generated Profile:", size=18, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
            output_container,
        ], spacing=10)
    )
